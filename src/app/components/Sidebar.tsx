const Sidebar = ({ className }: { className: string }) => {
    return (
        <aside className={`flex flex-col h-screen py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 md:hidden absolute left-0 top-0 transition-all duration-300 ${className}`}>
